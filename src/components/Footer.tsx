        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Next-generation cyber security solutions protecting organizations worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <NavLink to="/enterprise-security" className="text-muted-foreground hover:text-primary transition-colors">
                  Enterprise Security
                </NavLink>
              </li>
              <li>
                <NavLink to="/network-infrastructure" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <NavLink to="/partners" className="text-muted-foreground hover:text-primary transition-colors">
                  Partners
                </NavLink>
              </li>
            </ul>
