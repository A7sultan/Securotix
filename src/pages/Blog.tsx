...
const posts = [
  {
    ...
    excerpt: "Exploring how artificial intelligence is being weaponized by threat actors and how to defend against it.",
    author: "Sarah Chen",
    date: "Dec 15, 2024",
  ...
  },
  {
    ...
    excerpt: "Common cloud security pitfalls and how to prevent them in your infrastructure.",
  ...
  },
  {
    ...
    excerpt: "Latest ransomware trends and effective defense mechanisms for organizations.",
    author: "Sarah Chen",
    date: "Dec 8, 2024",
    category: "Threat Intelligence",
  },
  {
    ...
    excerpt: "How quantum computing will revolutionize data encryption and security.",
    author: "Marcus Rodriguez",
    date: "Dec 5, 2024",
    category: "Innovation",
  },
  {
    ...
    excerpt: "Strategies for identifying and mitigating security risks from within your organization.",
    author: "Emily Thompson",
    date: "Dec 3, 2024",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20 space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              Latest trends, best practices, and expert analysis in cyber security
            </p>
          </div>
          ...
          <div className="mb-16">
            <div className="cyber-border rounded-lg p-12 glass hover-lift hover-glow transition-all cursor-pointer">
              <div className="flex items-center gap-4 mb-4 text-sm text-muted-foreground">
                <span className="px-3 py-1 rounded-full bg-primary/10 text-primary">Featured</span>
