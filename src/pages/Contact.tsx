          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="cyber-border rounded-lg p-8 glass hover-lift">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">security@cyberguard.com</p>
                    <p className="text-muted-foreground">support@cyberguard.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="cyber-border rounded-lg p-8 glass holographic text-center">
                <h3 className="text-2xl font-bold mb-2 text-primary text-glow">24/7 SOC Support</h3>
                <p className="text-muted-foreground mb-4">
                  Emergency security incidents? Our Security Operations Center is always available.
                </p>
